                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="faculty" id="faculty" class="form-control @error('faculty') is-invalid @enderror" name="faculty" required autocomplete="faculty" autofocus>
                                    <option value=""></option>
                        ...
                        <div class="row mb-3">
                            <label for="regno" class="col-md-4 col-form-label text-md-end">{{ __('Registration No.') }}</label>

                            <div class="col-md-6">
                                <input id="regno" type="text" class="form-control @error('regno') is-invalid @enderror" placeholder="2018/ICT/17" name="regno"  required autocomplete="regno" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" placeholder="076*******" name="phone"  required autocomplete="phone" autofocus>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <button type="reset" class="subbtn btn btn-danger">
                                    {{ __('Clear') }}
                                </button>
                            </div>
                        </div>
